...
/*
*   Updated: I wrote Integer each string of length at the first line into binary file, and Prog1B will be read those lengths to implement the program.
*
*
*/
...
public class Prog1A{
	...
	public static void main(String args[]){
		...
		writeFile = new File("input.bin");  // Used to create the writeFile ( Make binary file that contains binary data)
